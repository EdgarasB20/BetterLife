...
class _AddIncomeSheetState extends State<AddIncomeSheet> {
  ...
  void initState() {
    ...
    _category = initial?.category ?? IncomeCategory.salary;
  ...
  Future<void> _submit() async {
    ...
    try {
      final income = Income(
        ...
        category: _category,
        date: _date,
        createdAt: widget.initialIncome?.createdAt,
        updatedAt: widget.initialIncome?.updatedAt,
      );
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                _isEditing ? 'Redaguoti pajamą' : 'Pridėti pajamą',
                style: TextStyle(
                  fontSize: 22,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Pastaba',
                  hintText: 'Pvz. Mėnesinis atlyginimas',
                  labelStyle: TextStyle(color: subtext),
